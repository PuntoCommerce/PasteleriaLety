/******/ (function (modules) {
  ...
  \******************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          ...
          function () {
            return createCartBillingFormData;
          }
        );
        ...
        var loaderInstance = __webpack_require__(
          /*! ./loader */ "./cartridges/int_paypal/cartridge/client/default/js/loader.js"
        );
        ...
        function createCartBillingFormData(fieldsData, $paypalButton) {
          ...
          if (!$paypalButton) {
            $paypalButton =
              document.querySelector("#paypal_pdp_image") ||
              document.querySelector("#paypal_image") ||
              document.querySelector("#venmo_image");
          }

          var cartBillingFields =
            $paypalButton &&
            JSON.parse(
              $paypalButton.getAttribute("data-paypal-billing-form-fields")
            );
          Object.entries(cartBillingFields).forEach(function (entry) {
            ...
            if (_typeof(field) === "object") {
              cartBillingFormData.append(
                field.name,
                fieldsData && fieldsData[key] ? fieldsData[key] : field.value
              );
            }
          });
  ...
  \******************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _guest_initBillingButton__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./guest/initBillingButton */ "./cartridges/int_paypal/cartridge/client/default/js/billing/guest/initBillingButton.js"
          );
        /* harmony import */ var _registered_initBillingAgreementButton__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./registered/initBillingAgreementButton */ "./cartridges/int_paypal/cartridge/client/default/js/billing/registered/initBillingAgreementButton.js"
          );
        /* harmony import */ var _billingHelper__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./billingHelper */ "./cartridges/int_paypal/cartridge/client/default/js/billing/billingHelper.js"
          );
        /* harmony import */ var _registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./registered/billingAgreementHelper */ "./cartridges/int_paypal/cartridge/client/default/js/billing/registered/billingAgreementHelper.js"
          );

        var sdkLoaded = false;
        var $restPaypalAccountsList = document.querySelector(
          "#restPaypalAccountsList"
        );
        var isRegisteredUser =
          document
            .querySelector(".data-checkout-stage")
            .getAttribute("data-customer-type") === "registered";
        var $billingButtonContainer = document.querySelector(
          "#billing-paypal-button-container"
        );
        var isBAEnabled =
          $billingButtonContainer &&
          JSON.parse(
            $billingButtonContainer.getAttribute("data-is-ba-enabled")
          );
        var paypalUrls = document
          .querySelector(".js_paypal-content")
          .getAttribute("data-paypal-urls");
        window.paypalUrls = JSON.parse(paypalUrls);

        if (window.paypal && !isBAEnabled) {
          sdkLoaded = true;
          Object(
            _guest_initBillingButton__WEBPACK_IMPORTED_MODULE_0__["default"]
          )();
        } else {
          if (
            window.paypal &&
            Object(
              _billingHelper__WEBPACK_IMPORTED_MODULE_2__[
            ...
            Object(
              _registered_initBillingAgreementButton__WEBPACK_IMPORTED_MODULE_1__[
                "default"
              ]
            )();
            sdkLoaded = true;
          ...
          var ppPaymentOptionID = document
            .querySelector(".nav-link.paypal-tab")
            .parentElement.getAttribute("data-method-id");
          var activeTab = document.querySelector(".payment-information");
          document.querySelector(".nav-item .paypal-tab").click();

          if (
            ppPaymentOptionID !==
            activeTab.getAttribute("data-payment-method-id")
          ) {
          ...
          if (!isBAEnabled) {
            ...
            Object(
              _registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_3__[
        ...
        $('.payment-options[role=tablist] a[data-toggle="tab"]').on(
          "shown.bs.tab",
          _billingHelper__WEBPACK_IMPORTED_MODULE_2__["handleTabChange"]
        );
        ...
        if ($restPaypalAccountsList) {
          $restPaypalAccountsList.onchange = function (e) {
            ...
            if (
              ...
              Object(
                _billingHelper__WEBPACK_IMPORTED_MODULE_2__["injectBillingSDK"]
              )();
              sdkLoaded = true;
            }
        ...
        $("body").on(
          "checkout:updateCheckoutView",
          _billingHelper__WEBPACK_IMPORTED_MODULE_2__["updateClientSide"]
        );
        ...
        if (!isBAEnabled) {
          ...
          document.querySelector(".payment-summary .edit-button").onclick =
            function () {
              document.querySelector("button.place-order").innerText =
                "Place Order";
            };
        }
        ...
        if (document.querySelector(".paypal-checkbox-container")) {
          document
            .querySelectorAll(".paypal-checkbox-container .custom-checkbox")
            .forEach(function (checkbox) {
              return checkbox.addEventListener(
                "change",
                _registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_3__[
  ...
  \************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          ...
          "togglePaypalBtnVisibility",
          function () {
            return togglePaypalBtnVisibility;
          }
        );
        /* harmony export (binding) */ __webpack_require__.d(
          __webpack_exports__,
          "updateSessionAccountEmail",
          function () {
            return updateSessionAccountEmail;
          }
        );
        /* harmony export (binding) */ __webpack_require__.d(
          __webpack_exports__,
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          ...
          "updateSubmitOrderButton",
          function () {
            return updateSubmitOrderButton;
          }
        );
        /* harmony import */ var _guest_initBillingButton__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
        ...
        /* harmony import */ var _registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./registered/billingAgreementHelper */ "./cartridges/int_paypal/cartridge/client/default/js/billing/registered/billingAgreementHelper.js"
          );

        var $paypalButton = document.querySelector(
          ".js_paypal_button_on_billing_form"
        );
        var $paypalAccountsDropdown = document.querySelector(
          "#paypalAccountsDropdown"
        );
        ...
        function showPaypalBtn() {
          if (!$paypalButton) {
            $paypalButton = document.querySelector(
              ".js_paypal_button_on_billing_form"
            );
          }
        ...
        function showPaypalBlock() {
          if (!$paypalAccountsDropdown) {
            $paypalAccountsDropdown = document.querySelector(
              "#paypalAccountsDropdown"
            );
          }
        ...
        function injectBillingSDK() {
          ...
          script.onload = function () {
            isBAEnabled
              ...
              : Object(
                  _guest_initBillingButton__WEBPACK_IMPORTED_MODULE_0__[
                    "default"
                  ]
                )();
          };
          ...
          script.setAttribute(
            ...
            window.paypalUrls.partnerAttributionId
          );
        ...
        function isNewAccountSelected($accountList) {
          return (
            $accountList.querySelector("option:checked").value === "newaccount"
          );
        }
        /**
        ...
        function handleTabChange(e) {
          ...
          if (isRegisteredUser && isBAEnabled) {
            Object(
              _registered_billingAgreementHelper__WEBPACK_IMPORTED_MODULE_2__[
                "assignEmailForSavedBA"
              ]
            )();
            Object(
        ...
        function updateSessionAccountEmail(_, _ref) {
          ...
          showPaypalBlock();
          var $sessionPaypalAccount = document.querySelector(
            "#sessionPaypalAccount"
          );
        ...
        function updateClientSide(_, customer) {
          var selectedPaymentInstruments =
            customer.order.billing.payment.selectedPaymentInstruments;
          var paypalPaymentMethod = document
            .querySelector(".nav-link.paypal-tab")
            .parentElement.getAttribute("data-method-id");
          var giftCertTabLink = document.querySelector(
            ".nav-link.gift-cert-tab"
          );
          var $sessionPaypalAccount = $restPaypalAccountsList.querySelector(
          ...
          if (
            ...
            selectedPaymentInstruments.forEach(function (paymentInstr) {
              if (paymentInstr.paymentMethod !== paypalPaymentMethod) {
                if (!isBAEnabled) {
                  $sessionPaypalAccount.value = "";
                  $restPaypalAccountsList.querySelector(
                    "option:checked"
                  ).value = "newaccount";
                  ...
                  var $defaultBA = $restPaypalAccountsList.querySelector(
            ...
            if (
              selectedPaymentInstruments.find(function (paymentInstr) {
                return (
                  paymentInstr.paymentMethod ===
                  giftCertTabLink.parentElement.getAttribute("data-method-id")
                );
              })
            ) {
  ...
  \**********************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../api */ "./cartridges/int_paypal/cartridge/client/default/js/api.js"
          );
        /* harmony import */ var _billingHelper__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../billingHelper */ "./cartridges/int_paypal/cartridge/client/default/js/billing/billingHelper.js"
          );
        /* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../../helper */ "./cartridges/int_paypal/cartridge/client/default/js/helper.js"
          );
        function _slicedToArray(arr, i) {
          return (
            _arrayWithHoles(arr) ||
        ...
        function filterValidFormElement(str) {
          return (
            (str.indexOf("addressFields") !== -1 ||
              str.indexOf("contactInfoFields") !== -1) &&
        ...
        function createOrder(_, actions) {
          loader.show();
          return Object(
            _api__WEBPACK_IMPORTED_MODULE_0__["getPurchaseUnits"]
          )().then(function (purchase_units) {
            var parsedPurchaseUnit = purchase_units[0];

            if (JSON.parse(parsedPurchaseUnit.amount.value) === 0) {
              Object(
                _api__WEBPACK_IMPORTED_MODULE_0__["showCheckoutErrorHtml"]
              )("Order total 0 is not allowed for PayPal");
            }
        ...
        function onApprove(data, actions) {
          ...
          if (
            Object(_billingHelper__WEBPACK_IMPORTED_MODULE_1__["isLpmUsed"])(
              $usedPaymentMethod
            )
          ) {
            actions.order
              ...
              .then(function (_ref) {
                ...
                loader.hide();
                Object(
                  _helper__WEBPACK_IMPORTED_MODULE_2__["processLpmConfirmForm"]
                )(redirectUrl);
              })
              .catch(function () {
                loader.hide();
          ...
          var $selectedAccount = document.querySelector(
            "#sessionPaypalAccount"
          );
        ...
        function onError() {
          ...
          if (
            ...
            Object(_api__WEBPACK_IMPORTED_MODULE_0__["showCheckoutErrorHtml"])(
        ...
        function initPaypalButton() {
          ...
          window.paypal
            .Buttons({
              ...
              onError: onError,
              style: Object(
                _helper__WEBPACK_IMPORTED_MODULE_2__["getPaypalButtonStyle"]
              )(document.querySelector(".js_paypal_button_on_billing_form")),
            })
  ...
  \********************************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          ...
          "setBAFormValues",
          function () {
            return setBAFormValues;
          }
        );
        /* harmony import */ var _billingHelper__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../billingHelper */ "./cartridges/int_paypal/cartridge/client/default/js/billing/billingHelper.js"
          );

        var $billingBAbutton = document.querySelector(
        ...
        var $paypalAccountMakeDefault = document.querySelector(
          "#paypalAccountMakeDefault"
        );
        /**
        ...
        function showPaypalBABtn() {
          if (!$billingBAbutton) {
            $billingBAbutton = document.querySelector(
              ".paypal-checkout-ba-button"
            );
          }
          ...
          Object(
            _billingHelper__WEBPACK_IMPORTED_MODULE_0__["hideContinueButton"]
          )();
        }
        ...
        function hidePaypalBABtn() {
          ...
          Object(
            _billingHelper__WEBPACK_IMPORTED_MODULE_0__["showContinueButton"]
          )();
        }
        ...
        function saveCheckboxState() {
          var $paypal_makeDefault = document.querySelector(
            "#paypal_makeDefault"
          );
          var $paypal_saveAccount = document.querySelector(
            "#paypal_saveAccount"
          );
        ...
        function handleCheckboxChange() {
          var $selectedAccount =
            $restPaypalAccountsList.querySelector("option:checked");
          var isSessionAccountAppended = JSON.parse(
            $selectedAccount.getAttribute("data-append")
          );
          var hasDefaultPaymentMethod = JSON.parse(
            $restPaypalAccountsList.getAttribute("data-has-default-account")
          );

          if (
            isSessionAccountAppended ||
        ...
        function toggleCustomCheckbox() {
          var $selectedAccount =
            $restPaypalAccountsList.querySelector("option:checked");
          var $paypalAccountMakeDefaultContainer = document.querySelector(
            "#paypalAccountMakeDefaultContainer"
          );
          var $paypalAccountSaveContainer = document.querySelector(
            "#savePaypalAccountContainer"
          );
          var hasPPSavedAccount = JSON.parse(
            $restPaypalAccountsList.getAttribute("data-has-saved-account")
          );
          var hasDefaultPaymentMethod = JSON.parse(
            $restPaypalAccountsList.getAttribute("data-has-default-account")
          );
          ...
          var isBALimitReached = JSON.parse(
            $restPaypalAccountsList.getAttribute("data-ba-limit-reached")
          );
          ...
          if ($paypalAccountSaveContainer) {
            ...
            var isDataSetDefault =
              $selectedAccount.dataset.default === "false" ||
              $selectedAccount.dataset.default === "null";
            ...
            if (
              ...
              if (!hasPPSavedAccount) {
                ...
                if (
                  ($selectedAccount.value !== "newaccount" &&
                    (hasDefaultPaymentMethod || isSessionAccountAppended)) ||
                  ($selectedAccount.value === "newaccount" &&
                    !isSessionAccountAppended)
                ) {
                  $paypalAccountSave.checked = true;
        ...
        function toggleBABtnVisibility() {
          ...
          if (
            Object(
              _billingHelper__WEBPACK_IMPORTED_MODULE_0__[
                "isNewAccountSelected"
              ]
            )($restPaypalAccountsList)
          ) {
          ...
          hidePaypalBABtn();
          Object(
            _billingHelper__WEBPACK_IMPORTED_MODULE_0__["showPaypalBlock"]
          )();
        }
        ...
        function assignEmailForSavedBA() {
          var $paypalActiveAccount = document.querySelector(
            "#paypal_activeAccount"
          );
          var $selectedAccount =
            $restPaypalAccountsList.querySelector("option:checked");
          ...
          if (
            ...
            $paypalActiveAccount.value =
              $restPaypalAccountsList.querySelector("option:checked").value;
            setBAFormValues(
              $selectedAccount.dataset.baId,
              $selectedAccount.value
            );
          }
        }
  ...
  \************************************************************************************************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _billingAgreementHelper__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./billingAgreementHelper */ "./cartridges/int_paypal/cartridge/client/default/js/billing/registered/billingAgreementHelper.js"
          );
        /* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../../helper */ "./cartridges/int_paypal/cartridge/client/default/js/helper.js"
        ...
        function createBillingAgreement() {
          loader.show();
          return Object(
            _api__WEBPACK_IMPORTED_MODULE_0__["getBillingAgreementToken"]
          )()
            .then(function (data) {
              return data.token;
            })
        ...
        function onApprove(_ref) {
          ...
          return Object(
            _api__WEBPACK_IMPORTED_MODULE_0__["createBillingAgreementCall"]
          )(billingToken)
            .then(function (_ref2) {
              var id = _ref2.id,
                payer = _ref2.payer;
              ...
              document
                .querySelector("#sessionPaypalAccount")
                .setAttribute("data-ba-id", id);
              Object(
                _billingAgreementHelper__WEBPACK_IMPORTED_MODULE_1__[
                  "setBAFormValues"
                ]
              )(id, payerInfo.email);

              if (hasDefaultPaymentMethod && !hasPPSavedAccount) {
                $restPaypalAccountsList.setAttribute(
                  "data-has-default-account",
                  false
                );
                $("#restPaypalAccountsList").data(
                  "data-has-default-account",
                  false
                ); // MFRA jquery hack
              }
              ...
              var contactInfoFields = [].slice.call(
                document.querySelectorAll(".contact-info-block input[required]")
              );
              var keysValues = {
              ...
              var $billinAddressBlock = document.querySelector(
                ".billing-address-block"
              );

              if (
                $billinAddressBlock.querySelector(
                  "#billingAddressSelector option:checked"
                ).value === "new"
              ) {
                billingAddressFields = [].slice.call(
                  $billinAddressBlock.querySelectorAll(
              ...
              $("button.submit-payment").click();
              var sameAttribute = [].slice
                .call($restPaypalAccountsList.options)
                .find(function (el) {
        ...
        function initPaypalBAButton() {
          ...
          window.paypal
            .Buttons({
              ...
              style: Object(
                _helper__WEBPACK_IMPORTED_MODULE_2__["getPaypalButtonStyle"]
              )(document.querySelector(".paypal-checkout-ba-button")),
            })
