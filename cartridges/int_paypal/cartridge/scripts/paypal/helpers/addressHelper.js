 ...
 */
addressHelper.updateOrderBillingAddress = function (basket, billingAddress, firstName, lastName) {
    var {
        name,
        address,
        phone,
 ...
 * @param  {Object} billingAddress user's billing address
 */
addressHelper.updateBABillingAddress = function (basket, billingAddress, firstName, lastName) {
    var {
        first_name,
        last_name,
        billing_address,
