...
exports.calculate = function (basket) {
    ...
    HookMgr.callHook('dw.order.calculateTax', 'calculateTax', basket);
     ...
     /* Add Marketplacer shipping adjustment if any after discounts are applied
    * Marketplacer shipping adjustment is removed first and added again so that shipping cost of Marketplacer items are not affected by client shipping promotions
    */
     HookMgr.callHook('marketplacer.shipping.shippingadjustment','getOrderShippingDetails');
